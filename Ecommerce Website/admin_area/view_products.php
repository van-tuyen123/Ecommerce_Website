    ...
    <tbody class="bg-secondary text-light">
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            <tr class='text-center'>
                ...
                <td class='bg-secondary text-light'><a href='index.php?edit_products=<?php echo $product_id?>' class='text-light'><i class='fa-solid fa-pen-to-square bg-secondary'></i></a></td>
                <td class='bg-secondary text-light'><a href='index.php?delete_product=<?php echo $product_id?>' class='text-light'><i class='fa-solid fa-trash bg-secondary'></i></a></td>
            </tr>
            <?php
        }
        ?>
