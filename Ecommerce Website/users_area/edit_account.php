...
<head>
    ...
    <h3 class="text-success text-success mb-4 text-center">Edit Account</h3>
    <form action="" method="post" enctype="multipart/form-data" >
        ...
        <input type="submit" value="Update" class="bg-info py-2 px-3 border-0 rounded-3 bg-danger text-white" name="user_update">
    </form>
<body>
</body>
</html>