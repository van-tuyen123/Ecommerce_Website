...
if(isset($_POST['edit_products'])){
    ...
    if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or 
    $product_image3=='' or $product_price==''){
        ...
        $update_product = "UPDATE `products` SET product_title='$product_title', product_keywords='$product_keywords',
        product_description='$product_desc', category_id='$product_category', brand_id='$product_brands',
